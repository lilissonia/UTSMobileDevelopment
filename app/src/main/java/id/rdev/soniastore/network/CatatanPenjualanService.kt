package id.rdev.soniastore.network

import id.rdev.soniastore.activity.data_barang.data.ResultDataBarang
import id.rdev.soniastore.activity.login.data.ResultLogin
import id.rdev.soniastore.activity.penjualan.data.ResultKeranjang
import id.rdev.soniastore.activity.penjualan.data.ResultSearchBarang
import id.rdev.soniastore.activity.report.detail.data.ResultItemKeranjang
